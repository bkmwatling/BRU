...
typedef struct {
    ...
    Program *(*program)(const void *scheduler_impl);
...
#define THREAD_MANAGER_DEFINE_WRAPPERS(prefix, thread_type)                \
    ...
    {                                                                      \
        prefix##_try_inc_sp((thread_type *) thread);                       \
                                                                           ...
                                                                           \
    static len_t *prefix##_captures_wrapper(const void *thread,            \
                                            len_t      *ncaptures)         \
    {                                                                      \
    ...
    {                                                                      \
        prefix##_inc_counter((thread_type *) thread, idx);                 \
                                                                           ...
                                                                           \
    static mem_t prefix##_memory_wrapper(const void *thread, len_t idx)    \
    {                                                                      \
    ...
    {                                                                         \
        return prefix##_clone_with((const scheduler_type *) scheduler_impl,   \
                                   (thread_type *) thread);                   \
                                                                              ...
                                                                              \
    static Program *prefix##_program_wrapper(const void *scheduler_impl)      \
    {                                                                         \
